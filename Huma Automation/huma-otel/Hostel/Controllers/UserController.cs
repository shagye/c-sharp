...
namespace Hostel.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Index(FormCollection coll)
        {
            ...
            if (username == "")
            {
                ViewBag.message = "<div class='alert alert-danger'><strong>Oops!!</strong> Kullanıcı adı boş olamaz</div>";
                     ...
                     if (user.Password == password)
                      {
                        if (user.status == "Active")
                        {
                            ...
                            {
                                ViewBag.message = "<div class='alert alert-danger'><strong>Oops!!</strong> Erişiminiz yok. Lütfen Admin ile İletişime Geçiniz</div>";
                                ViewBag.username = username;
                                return View();
                            }
                        }
                      ...
                      {
                        ViewBag.message = "<div class='alert alert-danger'><strong>Oops!!</strong> Kullanıcı adı veya şifreyi hatalı girdiniz.</div>";
                        ViewBag.username = username;
                        return View();
                    }
            ...
            if ((string)Session["type"] == "Admin" || (string)Session["type"] == "Manager" || (string)Session["type"] == "Member")
            {
                ...
                if(oldpassword!="" && newpassword!="" && confirmpassword != "")
                {
                    if (user.Password == oldpassword)
                    {
                        ...
                        {
                            ViewBag.message = "<div class='alert alert-danger'><strong>Oops!!</strong> Şifrelerin eşlemediğini onayla</div>";
                        }
                    }
                    else
                    {
                        ViewBag.message = "<div class='alert alert-danger'><strong>Error!!</strong> Şifreyi hatalı girdiniz.</div>";
                    }
                }
                else
                {
